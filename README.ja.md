...
- three.js **r184** 以上 (`three/webgpu` と `three/tsl`)。WebGPU / WebGL2 で検証済み: [照明の互換性検証](docs/r185-lighting-regression.md)の **0.184.0 と 0.185.1**、および[出力切替タイミング修正](docs/r186-compatibility.md)を含む **0.186.0**。

...
- three.js **r184** or newer (`three/webgpu` and `three/tsl`). Verified on WebGPU and WebGL2: **0.184.0 and 0.185.1** in the [lighting compatibility regression](docs/r185-lighting-regression.md), and **0.186.0** with the [output-switch timing fix](docs/r186-compatibility.md).
